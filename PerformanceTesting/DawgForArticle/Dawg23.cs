...
{
    public sealed unsafe class Dawg23 : IDawg
    {
        private readonly PointerGraph _graph;

        public Dawg23(Stream stream)
            : this(new CompressedSparseRowGraph(stream))
        { }

        public Dawg23(CompressedSparseRowGraph graph) : this(new PointerGraph(graph))
        { }

        public Dawg23(PointerGraph graph)
        {
            _graph = graph;
